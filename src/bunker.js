      ...
      card.innerHTML = `
        ...
        <div class="flex items-center justify-between pt-2.5 border-t border-white/10 text-[10px] font-mono">
          ...
          <div class="flex items-center gap-2">
            <button class="btn-edit-item px-2.5 py-1.5 rounded-lg bg-cyan-500/20 hover:bg-cyan-500 text-cyan-300 hover:text-slate-950 transition-all flex items-center gap-1 font-bold" data-id="${item.id}" title="Editar foto y texto">
              <span>✏️</span>
              <span>Editar</span>
            </button>
